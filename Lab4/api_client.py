...
TEST_KEY = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NTU0MTk3MDUsImlhdCI6MTUzOTg2NzcwNSwibmJmIjoxNTM5ODY3NzA1LCJpZGVudGl0eSI6MX0.tK5PiXC5LLEKS37hV6n5sWYlcewQCZG1v-6rLPC24LI"
# "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NTQyMjMwNzgsImlhdCI6MTUzODY3MTA3OCwibmJmIjoxNTM4NjcxMDc4LCJpZGVudGl0eSI6MTAwfQ.RPxXYSpX9UfkVr2WDGtNWdRYYD15n8sVPKM4pym2iCQ"
...
class ApiClient(object):
    ...
    def get_fashion_mnist_data(self, num_samples):
        val = requests.get(API_PRIVATE_URL, 
                            headers={"Authorization":"JWT "+ self.data}, 
                            params={"command": "get_fashion_mnist_data", "num_samples": num_samples})
        val = json.loads(val.text)
        return val["result"]["data"]

    def get_toxic_data(self, num_samples):
        val = requests.get(API_PRIVATE_URL, 
                            headers={"Authorization":"JWT "+ self.data}, 
                            params={"command": "get_toxic_data", "num_samples": num_samples})
        val = json.loads(val.text)
        return val["result"]["data"]
